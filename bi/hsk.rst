...
and monitoring Apache Hadoop clusters. As of version 2.0 of the IBM Big Insights (BI), Ambari can be used to setup and deploy Hadoop clusters
...
More information on IBM BI and Ambari can be found at http://http://www-03.ibm.com/software/products/en/ibm-biginsights-for-apache-hadoop
